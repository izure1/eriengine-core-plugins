...
module.exports = {
    mode,
    entry: {
      'eriengine-core-plugin-optimization': [
          '@babel/polyfill',
          path.resolve(__dirname, 'src', 'eriengine-core-plugin-optimization.ts')
      ]
    },
    output: {
        path: path.resolve(__dirname, 'dist', 'optimization', 'src'),
        filename: 'eriengine-core-plugin-optimization.js',
        library: 'eriengine-core-plugin-optimization',
        libraryTarget: 'umd'
    },
    externals: [
        'phaser'
