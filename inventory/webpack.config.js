...
module.exports = {
    mode,
    entry: {
      'eriengine-core-plugin-inventory': [
          '@babel/polyfill',
          path.resolve(__dirname, 'src', 'eriengine-core-plugin-inventory.ts')
      ]
    },
    output: {
        path: path.resolve(__dirname, 'dist', 'inventory', 'src'),
        filename: 'eriengine-core-plugin-inventory.js',
        library: 'eriengine-core-plugin-inventory',
        libraryTarget: 'umd'
    },
    externals: [
        'phaser'
