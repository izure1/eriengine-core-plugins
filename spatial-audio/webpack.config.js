...
module.exports = {
  mode,
  entry: {
    'eriengine-core-plugin-spatial-audio': [
      '@babel/polyfill',
      path.resolve(__dirname, 'src', 'eriengine-core-plugin-spatial-audio.ts')
    ]
  },
  output: {
    path: path.resolve(__dirname, 'dist', 'spatial-audio', 'src'),
    filename: '[name].js',
    library: 'eriengine-core-plugin-spatial-audio',
    libraryTarget: 'umd'
  },
  externals: [
    'phaser'
