...
module.exports = {
  mode,
  entry: {
      'eriengine-core-plugin-feeling': [
          '@babel/polyfill',
          path.resolve(__dirname, 'src', 'eriengine-core-plugin-feeling.ts')
      ]
  },
  output: {
      path: path.resolve(__dirname, 'dist', 'feeling', 'src'),
      filename: '[name].js',
      library: 'eriengine-core-plugin-feeling',
      libraryTarget: 'umd'
  },
  externals: [
      'phaser'
